...
export default function LoggedOutHero({ loading, loginGoogle }) {
  ...
  return (
    ...
    >
      <section className="relative overflow-hidden rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white/70 dark:bg-neutral-900/60 p-6 sm:p-10 shadow-sm">
        ...
        <div className="text-center">
          ...
          <p className="mt-3 text-sm sm:text-base text-neutral-600 dark:text-neutral-400">
            ...
            modals, and read-only sharing. Secure with Firebase + MongoDB.
          </p>
        </div>
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-3">
          <motion.button
            onClick={loginGoogle}
            disabled={loading}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-violet-600 text-white text-sm font-medium hover:bg-violet-500 disabled:opacity-50"
        ...
        >
          {[
            { icon: "/window.svg", label: "Clean UI" },
            { icon: "/file.svg", label: "Categories" },
            { icon: "/globe.svg", label: "Share view-only" },
            { icon: "/next.svg", label: "Next.js App Router" },
            { icon: "/vercel.svg", label: "Deploy-ready" },
            { icon: "/globe.svg", label: "Fast + Secure" },
          ].map((f) => (
            <motion.div
              key={f.label}
        ...
        <div className="mt-8">
          <div className="rounded-xl border border-neutral-200 dark:border-neutral-800 bg-gradient-to-br from-neutral-50/90 to-white/70 dark:from-neutral-900/60 dark:to-neutral-950/40 p-4 sm:p-6 shadow-inner">
            <div className="flex items-center gap-2 text-[11px] text-neutral-500 mb-3">
              <Image src="/window.svg" alt="" width={14} height={14} />
              Preview
            </div>
